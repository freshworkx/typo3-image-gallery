...
* TYPO3 9: Route Enhancer example for speaking URLs, see `example file <https://github.com/Leuchtfeuer/typo3-image-gallery/blob/master/Resources/Private/Examples/RouteEnhancer.yml>`__
