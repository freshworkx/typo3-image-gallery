...
This release is a feature release. It contains bug fixes and introduces documentation for `docs.typo3.org`__. Also it introduces
...
`GitHub <https://github.com/bitmotion/typo3-image-gallery/releases/tag/4.1.0>`__.
